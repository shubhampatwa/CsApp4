...
$sql="select * from submitassignments where branch='".$branch."' and section='".$section."' and year='".$year."'";
$query=mysqli_query($con,$sql);
while ($row=mysqli_fetch_array($query)) {

	echo "<li class=collection-item><strong>".$row['branch']." ".$row['section']." ".$row['year']." "  .$row['subject']."    ".$row['rollno']."</strong>     <a href='".$row['link']."'>link</a></li>";
}
}
?>
</ul>

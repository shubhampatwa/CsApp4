...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $sql="insert into timetable(id,branch,section,year,link) values(NULL,'".$_POST['branch']."','".$_POST['section']."','".$_POST['year']."','".$target_file."')";
...
<nav>
    <div class="nav-wrapper">
      <a href="#!" class="brand-logo">Upload TimeTable</a>
      <a href="#" data-activates="mobile-demo" class="button-collapse" onclick="self.close()"><i class="fa fa-arrow-left" ></i></a>
      </div>
      </nav> <form enctype='multipart/form-data' action='uploadtimetable.php' method='post'>
...
<input type="file" size="100" placeholder="timetable file" name="fileToUpload"></input>
